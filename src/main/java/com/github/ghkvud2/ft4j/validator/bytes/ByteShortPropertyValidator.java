...
import com.github.ghkvud2.ft4j.property.bytes.ShortProperty;

public class ByteShortPropertyValidator implements BytePropertyValidator {

	@Override
	public boolean support(AnnotationFieldProperty property) {
		return property.getClass().isAssignableFrom(ShortProperty.class);
	}
