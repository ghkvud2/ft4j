...
import com.github.ghkvud2.ft4j.property.bytes.IntProperty;

public class ByteIntPropertyValidator implements BytePropertyValidator {

	@Override
	public boolean support(AnnotationFieldProperty property) {
		return property.getClass().isAssignableFrom(IntProperty.class);
	}
